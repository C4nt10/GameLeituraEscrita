# -*- coding: utf-8 -*-
#
# VENDORIZADO de github.com/alvelvis/fonetizador (branch master,
# 2026-09-22) — nao esta no PyPI, sem licenca declarada no repositorio
# de origem. OK pra investigacao/spike (rodada 17, ver
# specs/001-mvp-desafios-leitura-matematica/research.md secao T002);
# NAO usar como dependencia de produto sem resolver a licenca com o
# autor ou trocar por alternativa licenciada.
